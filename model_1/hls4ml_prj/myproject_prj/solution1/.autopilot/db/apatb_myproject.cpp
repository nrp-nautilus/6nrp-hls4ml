...
extern "C"
void myproject_hw_stub_wrapper(void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_fc1_input, void* __xlx_apatb_param_layer13_out_0, void* __xlx_apatb_param_layer13_out_1, void* __xlx_apatb_param_layer13_out_2, void* __xlx_apatb_param_layer13_out_3, void* __xlx_apatb_param_layer13_out_4)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_fc1_input),
#endif
  };
  port0.param = __xlx_apatb_param_fc1_input;

  static hls::sim::Register port1 {
    .name = "layer13_out_0",
    .width = 16,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer13_out_0),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_layer13_out_0),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer13_out_0),
#endif
  };
  port1.param = __xlx_apatb_param_layer13_out_0;

  static hls::sim::Register port2 {
    .name = "layer13_out_1",
    .width = 16,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer13_out_1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_layer13_out_1),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer13_out_1),
#endif
  };
  port2.param = __xlx_apatb_param_layer13_out_1;

  static hls::sim::Register port3 {
    .name = "layer13_out_2",
    .width = 16,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer13_out_2),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_layer13_out_2),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer13_out_2),
#endif
  };
  port3.param = __xlx_apatb_param_layer13_out_2;

  static hls::sim::Register port4 {
    .name = "layer13_out_3",
    .width = 16,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer13_out_3),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_layer13_out_3),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer13_out_3),
#endif
  };
  port4.param = __xlx_apatb_param_layer13_out_3;

  static hls::sim::Register port5 {
    .name = "layer13_out_4",
    .width = 16,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer13_out_4),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_layer13_out_4),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer13_out_4),
#endif
  };
  port5.param = __xlx_apatb_param_layer13_out_4;
